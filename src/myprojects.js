const projects = {
  ...
  project1: {
    ...
    desc: `This application allows a Used Car Dealership to keep track and manage it's inventory, as well as display it for potential buyers. This web app utilizes a third-party API (CarMD) to collect accurate car data, AJAX calls to get/post/delete data, Node for back-end, Express for routing, NodeMailer for sending emails, and MySQL for saving/deleting car data for inventory purposes. The front-end design was built with HTML, CSS, and Foundation framework.`,
